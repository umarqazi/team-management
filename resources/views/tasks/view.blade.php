                            ...
                            <div class="allTasks">
                                ...
                                <div class="taskList">
                                    <ol class="eachTask" >
                                        @if($tasks != null)
                                            @foreach($tasks as $t)
                                                <li class="{{strtolower(str_replace(' ','-', $t->types))}} {{strtolower(str_replace(' ','-', $t->component))}} {{strtolower(str_replace(' ','-', $t->priority))}} {{strtolower(str_replace(' ','-', $t->workflow))}} @foreach($t->users as $user) {{strtolower(str_replace(' ','-', $user->name))}} @endforeach">
                                                    <a href="/tasks/{{$t->id}}">
                        ...
                        <div class="taskDetailBox">
                            ...
                            <div class="taskDetailBoxHeader">
                                ...
                                <div class="taskDetailBoxHeaderButtons">
                                    ...
                                    <button class="btn btn-default btn-sm"><span class="fa fa-clock-o"></span> Add Hour</button>
